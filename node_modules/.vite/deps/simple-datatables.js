...
var x = function(t2, e2, s2, i2, n2) {
  ...
  var r2 = D(a2, o2);
  return a2.every(function(t3, e3) {
    return x(t3, o2[e3], r2, true, true);
  });
};
    ...
    var t3 = function(t4, e3, s3, i3) {
      ...
      for (var h2 = 0; h2 < o3; h2++)
        for (var p2 = t4[h2], f2 = 0; f2 < r3; f2++) {
          var m2 = e3[f2];
          s3[h2] || i3[f2] || !x(p2, m2, d3, c2) ? l3[h2 + 1][f2 + 1] = 0 : (l3[h2 + 1][f2 + 1] = l3[h2][f2] ? l3[h2][f2] + 1 : 1, l3[h2 + 1][f2 + 1] >= n3 && (n3 = l3[h2 + 1][f2 + 1], a3 = [h2 + 1, f2 + 1]));
        }
...
var I = function() {
  ...
  return t2.prototype.init = function() {
    ...
    do {
      ...
      0 === (s2 = this.findNextDiff(t3, e2, [])).length && (O(t3, e2) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = true, M(t3), s2 = this.findNextDiff(t3, e2, [])))), s2.length > 0 && (this.foundAll = false, this.tracker.add(s2), k(t3, s2, this.options));
    } while (s2.length > 0);
        ...
        if (true === h2[_2])
          ...
          if (r2 = s2[h2[_2]], (o2 = Math.min(r2.newValue, f2.length - r2.length)) !== r2.oldValue) {
            ...
            for (var y2 = 0; y2 < r2.length; y2 += 1)
              x(f2[o2 + y2], f2[r2.oldValue + y2], {}, false, true) || (a2 = true);
            if (a2)
...
var U = B(z.exports = function() {
  ...
  O2.l = M2, O2.i = D2, O2.w = function(t3, e3) {
      ...
      if ("string" == typeof r3) {
        ...
        d3 && (h3 = o3[2]), a2 = this.$locale(), !l3 && h3 && (a2 = s3.Ls[h3]), this.$d = function(t5, e5, s4) {
          try {
            ...
            var i5 = u2(e5)(t5), n4 = i5.year, a3 = i5.month, o4 = i5.day, r4 = i5.hours, l4 = i5.minutes, d4 = i5.seconds, c4 = i5.milliseconds, h4 = i5.zone, p3 = new Date(), f3 = o4 || (n4 || a3 ? 1 : p3.getDate()), m3 = n4 || p3.getFullYear(), g2 = 0;
        ...
        }(e4, r3, i4), this.init(), h3 && true !== h3 && (this.$L = this.locale(h3).$L), c3 && e4 != this.format(r3) && (this.$d = new Date("")), a2 = {};
...
var nt = class {
  ...
  multiSearch(t2) {
    ...
    const s2 = e2.map((t3) => this.columns.settings.map((e3, s3) => {
      ...
      ["base", "accent"].includes(n2) && (i2 = i2.map((t4) => t4.toLowerCase())), ["base", "case"].includes(n2) && (i2 = i2.map((t4) => t4.normalize("NFD").replace(/\p{Diacritic}/gu, "")));
    ...
    this.data.data.forEach((t3, e3) => {
      const i2 = t3.cells.map((t4, e4) => {
        ...
        if (s3.length) {
          ...
          ["base", "accent"].includes(t5) && (s3 = s3.toLowerCase()), ["base", "case"].includes(t5) && (s3 = s3.normalize("NFD").replace(/\p{Diacritic}/gu, ""));
