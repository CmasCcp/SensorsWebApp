...
var ClientAuthError = class extends AuthError {
...
var ClientConfigurationError = class extends AuthError {
...
var InteractionRequiredAuthError = class extends AuthError {
...
var JoseHeaderError = class extends AuthError {
  constructor(errorCode, errorMessage) {
...
var BrowserAuthError = class extends AuthError {
  constructor(errorCode) {
...
var BrowserConfigurationAuthError = class extends AuthError {
  constructor(errorCode, errorMessage) {
    super(errorCode, errorMessage);
...
var FetchClient = class {
  ...
  async sendGetRequestAsync(url, options) {
    ...
    try {
      ...
      if (window.navigator.onLine) {
        ...
        throw createBrowserAuthError(noNetworkConnectivity2);
      }
    }
    try {
      return {
  ...
  async sendPostRequestAsync(url, options) {
    ...
    try {
      ...
      if (window.navigator.onLine) {
        throw createBrowserAuthError(postRequestFailed2);
      } else {
        throw createBrowserAuthError(noNetworkConnectivity2);
      }
    }
...
var NestedAppOperatingContext = class extends BaseOperatingContext {
  constructor() {
    super(...arguments);
...
var StandardOperatingContext = class extends BaseOperatingContext {
  /**
   * Return the module name.  Intended for use with import() to enable dynamic import
   * of the implementation associated with this operating context
   * @returns
...
var NativeAuthError = class extends AuthError {
...
var NativeMessageHandler = class {
...
var TokenCache = class {
  ...
  loadAccessToken(request, response, homeAccountId, environment, tenantId, options) {
    ...
    const expiresOn = options.expiresOn || response.expires_in + new Date().getTime() / 1e3;
    const extendedExpiresOn = options.extendedExpiresOn || (response.ext_expires_in || response.expires_in) + new Date().getTime() / 1e3;
...
var NestedAppAuthError = class extends AuthError {
  constructor(errorCode, errorMessage) {
    super(errorCode, errorMessage);
...
var NestedAppAuthController = class {
  constructor(operatingContext) {
    this.operatingContext = operatingContext;
...
var UnknownOperatingContext = class extends BaseOperatingContext {
  /**
   * Returns the unique identifier for this operating context
   * @returns string
   */
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-KJKJ6GAV.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.22.0 2024-08-28 *)
*/
//# sourceMappingURL=chunk-ERPQKDGN.js.map
